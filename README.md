...
Welcome to [Password Builder](https://password-builder.vercel.app/)! Get ready to create the most complicated password of your life. You must craft a password that adheres to a series of increasingly absurd rules. Enjoy a variety of mini-games that incorporate puzzles, and riddles to enhance the gameplay experience.

[Play Password Builder Now](https://password-builder.vercel.app/)
...
1. Clone this repository to your local machine using `git clone https://github.com/ishitjain11/password-builder`.
